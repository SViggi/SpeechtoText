...
- **Files:** `run_baseline.py` (implementation), `test1.txt`
  (sample input).

## Section 4. Test Case and Baseline Output

**Sample input** (`test1.txt`): a 4-speaker-turn lab meeting
...
python run_baseline.py --input test1.txt
```

Input: `test1.txt`. Output: printed to stdout as JSON (optionally
saved via `--output`).
